...
public class ReadCommittedLocker extends BuddyLocker {
	...
	public ReadCommittedLocker(EnvironmentImpl env, Locker buddy)
		...
		super(
				env,
				(buddy instanceof ReadCommittedLocker) ? ((ReadCommittedLocker) buddy)
						.getBuddy() : buddy);
		// #if TRANSACTIONS
	...
	/**
	 * Forwards this method to the transactional buddy. Since the buddy handles
	 * write locks, it knows whether this transaction created the node.
	 */
	 ...
	 * locks and therefore handles abort information.
	 */
