...
public abstract class LockManager implements EnvConfigObserver {
	 ...
	 *            NodeId to lock.
	 * @param lockerThe
	 *            Locker to lock this on behalf of.
	 * @param typeThe
	 *            lock type requested.
	 * @param timeoutmilliseconds
	 *            to time out after if lock couldn't be obtained. 0 means block
	 *            indefinitely. Not used if nonBlockingRequest is true.
	 * @param nonBlockingRequestif
	 *            true, means don't block if lock can't be acquired, and ignore
	 ...
	 * @throws DeadlockExceptionif
	 *             acquiring the lock would result in a deadlock.
	 */
	 ...
	 * 
	 * @param nodeIdThe
	 *            node ID of the lock to release.
	 ...
	 * 
	 * @param lockThe
	 *            lock to release. If null, use nodeId to find lock
	 * @param nodeIdThe
	 *            node ID of the lock to release, if lock is null. May not be
	 *            valid if lock is not null. MUST be valid if removeFromLocker
	 *            is true
	 * @param locker
	 * @param removeFromLockertrue
