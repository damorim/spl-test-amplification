...
//#endif
    ...
    try {
      ...
      while ((evictBytes < requiredEvictBytes) && (nNodesScannedThisRun <= inListStartSize)) {
...
//#if LOGGINGBASE
{
        Tracer.trace(detailedTraceLevel,envImpl,"Evictor: " + 
//#if STATISTICS
"pass="
//#endif
 + 
...
nEvictPasses
//#endif
 + " finished="+ finished+ " source="+ source+ " requiredEvictBytes="+ formatter.format(requiredEvictBytes)+ " evictBytes="+ formatter.format(evictBytes)+ " inListSize="+ inListStartSize+ " nNodesScanned="+ nNodesScannedThisRun+ 
//#if STATISTICS
" nNodesSelected="
//#endif
+ 
...
//#endif
      sb.append(" requiredEvict=").append(formatter.format(currentRequiredEvictBytes));
