...
public class TestRecoveryInfo_4 {


  //Test case number: 4
  /*
   * 67 covered goals:
   * 1 Weak Mutation 64: com.sleepycat.je.recovery.RecoveryInfo.appendLsn(Ljava/lang/StringBuffer;Ljava/lang/String;J)V:56 - ReplaceComparisonOperator == -> <=
   ...
   * 43 Weak Mutation 40: com.sleepycat.je.recovery.RecoveryInfo.toString()Ljava/lang/String;:37 - DeleteField: useRootLsnJ
   * 44 Weak Mutation 41: com.sleepycat.je.recovery.RecoveryInfo.toString()Ljava/lang/String;:38 - ReplaceConstant -  ckptEnd=< -> 
   * 45 Weak Mutation 46: com.sleepycat.je.recovery.RecoveryInfo.toString()Ljava/lang/String;:38 - DeleteStatement: append(Ljava/lang/String;)Ljava/lang/StringBuffer;
   * 46 Weak Mutation 47: com.sleepycat.je.recovery.RecoveryInfo.toString()Ljava/lang/String;:39 - ReplaceConstant -  useMaxNodeId= -> 
   * 47 Weak Mutation 44: com.sleepycat.je.recovery.RecoveryInfo.toString()Ljava/lang/String;:38 - DeleteStatement: append(Ljava/lang/Object;)Ljava/lang/StringBuffer;
   * 48 Weak Mutation 45: com.sleepycat.je.recovery.RecoveryInfo.toString()Ljava/lang/String;:38 - ReplaceConstant - > -> 
   * 49 Weak Mutation 51: com.sleepycat.je.recovery.RecoveryInfo.toString()Ljava/lang/String;:39 - DeleteStatement: append(J)Ljava/lang/StringBuffer;
   * 50 Weak Mutation 49: com.sleepycat.je.recovery.RecoveryInfo.toString()Ljava/lang/String;:39 - InsertUnaryOp Negation
   * 51 Weak Mutation 48: com.sleepycat.je.recovery.RecoveryInfo.toString()Ljava/lang/String;:39 - DeleteStatement: append(Ljava/lang/String;)Ljava/lang/StringBuffer;
   * 52 Weak Mutation 55: com.sleepycat.je.recovery.RecoveryInfo.toString()Ljava/lang/String;:40 - InsertUnaryOp +1
   * 53 Weak Mutation 54: com.sleepycat.je.recovery.RecoveryInfo.toString()Ljava/lang/String;:40 - InsertUnaryOp Negation
   * 54 Weak Mutation 53: com.sleepycat.je.recovery.RecoveryInfo.toString()Ljava/lang/String;:40 - DeleteStatement: append(Ljava/lang/String;)Ljava/lang/StringBuffer;
   * 55 Weak Mutation 52: com.sleepycat.je.recovery.RecoveryInfo.toString()Ljava/lang/String;:40 - ReplaceConstant -  useMaxDbId= -> 
   * 56 Weak Mutation 59: com.sleepycat.je.recovery.RecoveryInfo.appendLsn(Ljava/lang/StringBuffer;Ljava/lang/String;J)V:56 - ReplaceConstant - -1 -> 0
   * 57 Weak Mutation 58: com.sleepycat.je.recovery.RecoveryInfo.appendLsn(Ljava/lang/StringBuffer;Ljava/lang/String;J)V:56 - InsertUnaryOp Negation
   * 58 Weak Mutation 56: com.sleepycat.je.recovery.RecoveryInfo.toString()Ljava/lang/String;:40 - InsertUnaryOp -1
   * 59 Weak Mutation 62: com.sleepycat.je.recovery.RecoveryInfo.appendLsn(Ljava/lang/StringBuffer;Ljava/lang/String;J)V:56 - DeleteStatement: longSub(JJ)I
   * 60 Weak Mutation 61: com.sleepycat.je.recovery.RecoveryInfo.appendLsn(Ljava/lang/StringBuffer;Ljava/lang/String;J)V:56 - ReplaceConstant - -1 -> -2
   * 61 Weak Mutation 60: com.sleepycat.je.recovery.RecoveryInfo.appendLsn(Ljava/lang/StringBuffer;Ljava/lang/String;J)V:56 - ReplaceConstant - -1 -> 1
   * 62 Weak Mutation 68: com.sleepycat.je.recovery.RecoveryInfo.appendLsn(Ljava/lang/StringBuffer;Ljava/lang/String;J)V:57 - DeleteStatement: getNoFormatString(J)Ljava/lang/String;
   * 63 Weak Mutation 69: com.sleepycat.je.recovery.RecoveryInfo.appendLsn(Ljava/lang/StringBuffer;Ljava/lang/String;J)V:57 - DeleteStatement: append(Ljava/lang/String;)Ljava/lang/StringBuffer;
   * 64 Weak Mutation 65: com.sleepycat.je.recovery.RecoveryInfo.appendLsn(Ljava/lang/StringBuffer;Ljava/lang/String;J)V:56 - ReplaceComparisonOperator == -> -2
   * 65 Weak Mutation 66: com.sleepycat.je.recovery.RecoveryInfo.appendLsn(Ljava/lang/StringBuffer;Ljava/lang/String;J)V:57 - DeleteStatement: append(Ljava/lang/String;)Ljava/lang/StringBuffer;
   * 66 Weak Mutation 67: com.sleepycat.je.recovery.RecoveryInfo.appendLsn(Ljava/lang/StringBuffer;Ljava/lang/String;J)V:57 - InsertUnaryOp Negation
   * 67 Weak Mutation 64: com.sleepycat.je.recovery.RecoveryInfo.appendLsn(Ljava/lang/StringBuffer;Ljava/lang/String;J)V:56 - ReplaceComparisonOperator == -> <=
   */
  @Test
  public void test4()  throws Throwable  {
      ...
      recoveryInfo0.checkpointEndLsn = (-1331L);
      String string0 = recoveryInfo0.toString();
      assertEquals("Recovery Info ckptEnd=0xffffffff/0xfffffacd ckptEnd=<null> useMaxNodeId=0 useMaxDbId=0 numMapINs=0 numOtherINs=0 numBinDeltas=0 numDuplicateINs=0 lnFound=0 lnNotFound=0 lnInserted=0 lnReplaced=0 nRepeatIteratorReads=0", string0);
  }
}
