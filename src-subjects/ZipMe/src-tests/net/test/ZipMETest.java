...
public class ZipMETest {
    ...
    private static File fileToZip = new File("../ZipMe/src/net/test/ZipMETest.java");
    private static File zipFile = new File("../ZipMe/src/net/test/ZipMETest.java.zip");
    private static File unzipFile = new File("../ZipMe/src/net/test/ZipMETest.java-Copy.java");
