/*
 * SEFTestTokenizerProperties.java: JUnit test for TokenizerProperties implementations
 *
...
//-----------------------------------------------------------------------------
// Class SEFTestTokenizerProperties
//
 ...
 * @author  Heiko Blau
 */
public class SEFTestTokenizerProperties 
  extends TestCase 
  implements TokenizerPropertyListener
{
  ...
  public static void main(String[] args) {
    String[]   tests = { SEFTestTokenizerProperties.class.getName() };
  ...
  public static Test suite() {
    TestSuite   suite = new TestSuite(SEFTestTokenizerProperties.class.getName());
    
    suite.addTest(new SEFTestTokenizerProperties("testAddingSequences"));
    suite.addTest(new SEFTestTokenizerProperties("testAddingKeywords"));
    suite.addTest(new SEFTestTokenizerProperties("testGenericProperties"));
    suite.addTest(new SEFTestTokenizerProperties("testDataHandlers"));
    return suite;
  }
   ...
   */  
  public SEFTestTokenizerProperties(String test) {
    super(test);
  }
  ...
  */
  ...
  private final class LocalDataProvider implements DataProvider {
    ...
    /**
     * The constructor gets the constructing <code>SEFTestTokenizerProperties</code>
     * instanz
     */
    protected LocalDataProvider(SEFTestTokenizerProperties parent) {
      _parent = parent;
    }
    ...
    // members
    private SEFTestTokenizerProperties _parent;
  }
