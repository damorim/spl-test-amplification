/*
 * SEFTestDifficultSituations.java: JUnit test for a Tokenizer
 *
...
//-----------------------------------------------------------------------------
// Class SEFTestDifficultSituations
//
 ...
 * @author  Heiko Blau
 */
public class SEFTestDifficultSituations extends TestCase {
...
//    String[]   tests = { SEFTestDifficultSituations.class.getName() };
//    TestUtilities.run(tests, args);
    
    TestSuite ts = (TestSuite) SEFTestDifficultSituations.suite();
	  for (int i = 0; i < ts.countTestCases(); i++) {
		  ...
		  System.out.println("Error count on SEFTestDifficultSituations: " + tr.errorCount());
  ...
  public static Test suite() {
    TestSuite suite = new TestSuite(SEFTestDifficultSituations.class.getName());
    ...
    for (int sourceIndex = 0; sourceIndex < sourceClasses.length; ++sourceIndex) {
      suite.addTest(new SEFTestDifficultSituations("testSequencesAndSeparators", sourceClasses[sourceIndex]));
      suite.addTest(new SEFTestDifficultSituations("testSmallSource", sourceClasses[sourceIndex]));
      suite.addTest(new SEFTestDifficultSituations("testEmptySource", sourceClasses[sourceIndex]));
      suite.addTest(new SEFTestDifficultSituations("testSimilarSpecialSequences", sourceClasses[sourceIndex]));
      suite.addTest(new SEFTestDifficultSituations("testNonASCIICharacters", sourceClasses[sourceIndex]));
      suite.addTest(new SEFTestDifficultSituations("testEOFInLineComment", sourceClasses[sourceIndex]));
      suite.addTest(new SEFTestDifficultSituations("testEOFInBlockComment", sourceClasses[sourceIndex]));
      suite.addTest(new SEFTestDifficultSituations("testEOFInString", sourceClasses[sourceIndex]));
      suite.addTest(new SEFTestDifficultSituations("testStringEscapes1", sourceClasses[sourceIndex]));
      suite.addTest(new SEFTestDifficultSituations("testStringEscapes2", sourceClasses[sourceIndex]));
      suite.addTest(new SEFTestDifficultSituations("testNestedComments", sourceClasses[sourceIndex]));
      suite.addTest(new SEFTestDifficultSituations("testReaderSwitching", sourceClasses[sourceIndex]));
      suite.addTest(new SEFTestDifficultSituations("testDOSEOL", sourceClasses[sourceIndex]));
      suite.addTest(new SEFTestDifficultSituations("testMACEOL", sourceClasses[sourceIndex]));
      suite.addTest(new SEFTestDifficultSituations("testSpecialCalls", sourceClasses[sourceIndex]));
      suite.addTest(new SEFTestDifficultSituations("testLineCounting", sourceClasses[sourceIndex]));
      suite.addTest(new SEFTestDifficultSituations("testUncommonWhitespaces", sourceClasses[sourceIndex]));
      suite.addTest(new SEFTestDifficultSituations("testWhitespaceHandling", sourceClasses[sourceIndex]));
    }
    return suite;
  }
   ...
   */  
  public SEFTestDifficultSituations(String test, Class sourceClass) {
    super(test);
