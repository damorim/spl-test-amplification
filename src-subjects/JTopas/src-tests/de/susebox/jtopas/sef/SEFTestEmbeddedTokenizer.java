/*
 * SEFTestEmbeddedTokenizer.java: JUnit test for the StandardTokenizer
 *
...
//-----------------------------------------------------------------------------
// Class SEFTestEmbeddedTokenizer
//
 ...
 * @author  Heiko Blau
 */
public class SEFTestEmbeddedTokenizer extends TestCase {
   ...
   */
  public static final String CONFIG_FILE = "SEFTestEmbeddedTokenizer.conf";
  
  /**
   * Property for the test {@link #SEFTestEmbeddedTokenizer}
   */
  ...
  public static void main(String[] args) {
    String[]   tests = { SEFTestEmbeddedTokenizer.class.getName() };
  ...
  public static Test suite() {
    TestSuite   suite = new TestSuite(SEFTestEmbeddedTokenizer.class.getName());
    ...
    try {
      props.load(SEFTestEmbeddedTokenizer.class.getResourceAsStream(CONFIG_FILE));
    } catch (Exception ex) {
    ...
    while ((path = props.getProperty(PROP_PATH + count)) != null) {
      if ((url = SEFTestEmbeddedTokenizer.class.getResource(path)) != null) {
        path = url.getFile();
      }
      suite.addTest(new SEFTestEmbeddedTokenizer("SEFTestEmbeddedTokenizer", path));
      count++;
    }
    ...
    while ((path = props.getProperty(PROP_JAVAPATH + count)) != null) {
      ...
      suite.addTest(new SEFTestEmbeddedTokenizer("testJavaTokenizer", path));
      count++;
    }
    return suite;
  }
   ...
   */  
  public SEFTestEmbeddedTokenizer(String test, String path) {
    super(test);
    _path = path;
  }
   ...
   * @see   #SEFTestEmbeddedTokenizer
   */
  public void SEFTestEmbeddedTokenizer() throws Throwable {
    long                        start         = System.currentTimeMillis();
