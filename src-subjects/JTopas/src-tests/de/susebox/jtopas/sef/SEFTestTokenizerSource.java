/*
 * SEFTestTokenizerSource.java: JUnit test for a Tokenizer
 *
 ...
 * @author  Heiko Blau
 */
public class SEFTestTokenizerSource extends TestCase {
...
//    String[]   tests = { SEFTestTokenizerSource.class.getName() };
//
//    TestUtilities.run(tests, args);
    TestSuite ts = (TestSuite) SEFTestTokenizerSource.suite();
	  for (int i = 0; i < ts.countTestCases(); i++) {
		  ...
		  System.out.println("Error count on SEFTestTokenizerSource: " + tr.errorCount());
  ...
  public static Test suite() {
    TestSuite   suite = new TestSuite(SEFTestTokenizerSource.class.getName());
  
    suite.addTest(new SEFTestTokenizerSource("testEmptySource"));
    suite.addTest(new SEFTestTokenizerSource("testSmallBuffer"));
    suite.addTest(new SEFTestTokenizerSource("testLargeBuffer"));
    suite.addTest(new SEFTestTokenizerSource("testSpeed"));
    suite.addTest(new SEFTestTokenizerSource("testSimilarResults"));
    suite.addTest(new SEFTestTokenizerSource("testLargeSource"));
    return suite;
  }
   ...
   */  
  public SEFTestTokenizerSource(String test) {
    super(test);
  }
