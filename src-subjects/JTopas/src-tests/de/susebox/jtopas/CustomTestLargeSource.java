...
//		System.out.println(splBuffer.toString());		
  ...
  public static Test suite() {
	...
	private void splPrint___(String string) {
	...
	private static final String WITHOUT_COMMENTS_CODE_PIECE = 
	...
	private static final String SOMECOMMENTS_PIECE = 
		"package ours.my.subpackage;\n"
		+ "\n"
		+ "import java.util.*;\n"
		+ "import java.io.InputStream;\n"
	...
	private static final String ORIGINAL_CODE_PIECE = 
		"/**\n"
...
//	public static boolean BLOCKCOMMENTS___ = true;
//	public static boolean LINECOMMENTS___ = true;
//	public static boolean COUNTLINES___ = true;
//	public static boolean IMAGEPARTS___ = true;
//	public static boolean TOKENPOSONLY___ = true;

	public static final boolean WHITESPACES = false;	
	public static final boolean KEEPDATA = false; 
	
	private static String CODE_PIECE = WITHOUT_COMMENTS_CODE_PIECE;
	private static int    SMALL_LOOPS       = 1;
	
	public static void setTestId(int testId) {
		switch(testId) {
		case 1:
			CODE_PIECE = ORIGINAL_CODE_PIECE;
			SMALL_LOOPS = 1;
			break;
		case 2:
			CODE_PIECE = ORIGINAL_CODE_PIECE;
		...
		case 6:
			...
			break;
		case 7:
			CODE_PIECE = WITHOUT_COMMENTS_CODE_PIECE;
			SMALL_LOOPS = 1;
			break;
		case 8:
			CODE_PIECE = WITHOUT_COMMENTS_CODE_PIECE;
		...
		case 9:
			...
			break;
		default:
			System.err.println("TEST CASE DOESNT EXIST FOR JTOPAS");
			System.exit(0);
			break;
		}
	}
