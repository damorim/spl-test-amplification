		...
		__MAIN_LOOP__:
			do {
				...
				case Token.WHITESPACE:
					...
					returnIt = false;
					if(CustomTestLargeSource.WHITESPACES) //  <//isFlagSet(Flags.F_RETURN_SIMPLE_WHITESPACES));
						returnIt = true;
					break;
				...
				if (returnIt) {
					...
					//#endif
					boolean returnImageParts =  false; 
					//#if IMAGEPARTS___                
...
//		  switch(flag) {
//		  case Flags.F_COUNT_LINES:
//			  return VariationDriver.dr.choose(VariationDriver.COUNTLINES___);
//		  case Flags.F_RETURN_BLOCK_COMMENTS:
//			  return VariationDriver.dr.choose(VariationDriver.BLOCKCOMMENTS___);
//		  case Flags.F_RETURN_IMAGE_PARTS:
//			  return VariationDriver.dr.choose(VariationDriver.IMAGEPARTS___);
//		  case Flags.F_RETURN_LINE_COMMENTS:
//			  return VariationDriver.dr.choose(VariationDriver.LINECOMMENTS___);
//		  case Flags.F_TOKEN_POS_ONLY:
//			  return VariationDriver.dr.choose(VariationDriver.TOKENPOSONLY___);
//		  default:
